...
package defs {
  ...
  package exts {
    ...
    final class StreamJoinRightDistinctExt(val node: StreamJoinRightDistinct) extends AnyVal {
      import node._
    ...
    final class ApplyAggOpExt(val node: ApplyAggOp) extends AnyVal {
      import node._
